...
?>
							...
							<div class="col-md-12 align-self-center order-1">
								...
								<ul class="breadcrumb d-block text-center">
									...
									<li class="active">Votre compte</li>
								</ul>
							</div>
					...
					<div class="row">
							...
							<div class="d-flex justify-content-center mb-4">
								<div class="profile-image-outer-container">
									<div class="profile-image-inner-container bg-color-primary">
										<span id="uploaded_image"></span> <img id="uploaded_off" src="img/avatars/avatar.jpg">
						...
						<div class="col-lg-9">
							...
							<div class="overflow-hidden mb-4 pb-3">
								<p class="mb-0">Vous pouvez modifier ici vos informations personnelles</p>
							</div>
							...
							<form role="form" class="needs-validation">
							    ...
							    <div class="form-group row">
							       ...
							       <div class="form-group row">
							        <label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2">Ville / Code postale</label>
							        <div class="col-lg-6">
							            <input class="form-control" type="text" name="city" value="" placeholder="Ville">
							        </div>
							        <div class="col-lg-3">
							            <input class="form-control" type="text" name="state" value="" placeholder="Code postale">
							        </div>
							    </div>

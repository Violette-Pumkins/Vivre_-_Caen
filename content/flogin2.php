...
?>
                    ...
                    <?php echo $email_verify_success; ?>
							...
							<form id="frmSignUp" method="post">
								...
								<div class="form-row">
									<div class="form-group col">
                        <label class="text-color-dark text-3">Votre prenom <span class="text-color-danger">*</span></label>
                        <input type="text" class="form-control" name="firstname" id="firstName" />
								            ...
								            <div class="form-row">
									<div class="form-group col">
                        <label class="text-color-dark text-3">Last name <span class="text-color-danger">*</span></label>

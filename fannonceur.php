					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-6 text-color-dark my-3">Vous êtes professionnel ? Contactez nous pour avoir votre publicité dans notre magazine, Merci de compléter le formulaire ci dessous, nous vous contacterons<strong> dans les meilleurs délais.</strong></h1> 
...
<h4 class="text-primary pt-5" data-appear-animation="maskUp" data-appear-animation-delay="400">Zomm <strong> sur le projet</strong></h4>
</div>
<div class="overflow-hidden mb-3">
<div class="col-lg-6">
<ul class="list list-icons list-icons-style-3 list-secondary">
<li><i class="fas fa-check"></i> Un magazine gratuit tiré à 30 000 exemplaires en format A4 - qualité premium</li>
</ul>
<ul class="list list-icons list-icons-style-3 list-tertiary">
<li><i class="fas fa-check"></i> Un magazine relié au 1er groupe digital de l'agglomération de Caen (52 000 membres)</li>
</ul>
<ul class="list list-icons list-icons-style-3 list-quaternary">
<li><i class="fas fa-check"></i> Un magazine distribué sur Caen et son agglomération (286 000 personnes)</li>
</ul>
</div>
...
<li><i class="fas fa-map-marker-alt top-6"></i> <strong>Adresse:</strong> 29 Boulevard André Detolle, 14000 Caen</li>
<li><i class="fas fa-phone top-6"></i> <strong>Telephone:</strong> 07 49 96 05 27</li>
<li><i class="fas fa-envelope top-6"></i> <strong>Email:</strong> <a href="contact@vivreacaen.fr"><span>contact@vivreacaen.fr</span></a></li>
</ul>

<h4 class="text-primary pt-5">Nos <strong>Horaires</strong></h4>
<ul class="list list-icons list-dark mt-2">
<li><i class="far fa-clock top-6"></i> Laundi au vendredi - 10h–12h30 & 14h–18h30</li>
<li><i class="far fa-clock top-6"></i> Samedi - 14h–18h30</li>
								...
								<form class="contact-form" action="php/contact-form.php" method="POST">
									<div class="form-row">
										<div class="form-group col">
											...
											<input type="text" value="" data-msg-required="Votre entreprise" maxlength="100" class="form-control" name="name" required>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col">
...
<option value="1">Encart A8 "Commerce local / code réduction / Bon plan" 150 € HT</option>
<option value="2">Bandeau haut ou pied de page 475 € HT</option>
<option value="3">1/4 Page 475 € HT</option>
<option value="4">2/4 Page 875 € HT</option>
<option value="5">Pleine page 1600 € HT</option>
<option value="6">Double page 2500 € HT</option>
<option value="7">2e de couverture 2890€ HT</option>
<option value="8">3e de couverture 2490€ HT</option>
<option value="9">4e de couverture 3490€ HT</option>
</optgroup>
<optgroup label="Magazine + site">
<option value="10">Bandeau haut ou pied de page 575 € HT</option>
<option value="11">1/4 Page 575 € HT</option>
<option value="12">2/4 Page 975 € HT</option>
<option value="13">Pleine page 1700 € HT</option>
<option value="14">Double page 2600 € HT</option>
<option value="15">2e de couverture 2990€ HT</option>
<option value="16">3e de couverture 2590€ HT</option>
<option value="17">4e de couverture 3590€ HT</option>
</optgroup>

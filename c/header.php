							...
							<div class="header-column">
								<div class="header-row">
									<h1 class="header-logo">
										<a href="index.html">
											<img alt="Vivre à Caen - Le magazine" width="152" height="95" src="img/logo-default-slim.png">
...
?>
						<li class="dropdown dropdown-full-color dropdown-light">
																...
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="./?o=admin&add=1">Ajouter un article</a></li>
...
<a href="mon-compte.html" class="header-nav-features-toggle"> <img src="https://img.icons8.com/bubbles/100/000000/administrator-male.png"  width="40" alt="Connecté sous <?php echo $_SESSION['first_name']; ?>" class="header-nav-top-icon-img">  <!--<img src="img/icons/icon-cart-light.svg" width="14" alt="" class="header-nav-top-icon-img"> !-->
...
<div class="actions"> <a class="btn btn-blue" href="mon-compte.html">Mon compte</a></div>
